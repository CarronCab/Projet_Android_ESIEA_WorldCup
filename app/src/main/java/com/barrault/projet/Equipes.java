...
public class Equipes extends AppCompatActivity {
    ...
    private WorldCupAdapter worldCupAdapt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rv = findViewById(R.id.rv_worldcup);
        rv.setLayoutManager(new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false));
        worldCupAdapt= new WorldCupAdapter(getTeamFromFile());
        rv.setAdapter(worldCupAdapt);

        IntentFilter intentFilter = new IntentFilter(WORLD_CUP_UPDATE);
        LocalBroadcastManager.getInstance(this).registerReceiver(new WorldCupUpdate(),intentFilter);
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        switch (id) {
                            case R.id.credit:
                                Intent intentCredit = new Intent(Equipes.this, Credits.class);
                                startActivity(intentCredit);
                                return true;


                            case R.id.main_home:
                                Intent MainActivity = new Intent(Equipes.this, MainActivity.class);
                                startActivity(MainActivity);
                                return true;

                            case R.id.exit:
                                new AlertDialog.Builder(Equipes.this)
                                        .setCancelable(true)
                                        ...
                                        .setPositiveButton("Quitter", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                PendingIntent pendingIntent = PendingIntent.getActivity(Equipes.this, 0, new Intent(Equipes.this, MainActivity.class), 0);
                                                NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(Equipes.this)
                                                ...
                                                NotificationManagerCompat notificationManager = NotificationManagerCompat.from(Equipes.this);
    ...
    public JSONArray getTeamFromFile(){
        try {
            ...
            is.read(buffer);
            is.close();
            team = new JSONObject(new String(buffer, "UTF-8")).getJSONArray("teams");
            return team;
    ...
    public class WorldCupUpdate extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent){
            ...
            JSONArray JsonData = getTeamFromFile();
            Log.d("tag", "longueur du json array : " + JsonData.length());
            worldCupAdapt.setNewWorldCup(getTeamFromFile());
        }
    }
